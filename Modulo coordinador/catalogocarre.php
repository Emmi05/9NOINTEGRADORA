<html lang="en">
  <head>
    ...
    <title>Catalogo de Carreras</title>
 ...
 <!--========================================================== -->
  ...
  <nav class="navbar navbar-light px-3" style="background-color: #33afce;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light px-5">
     ...
     <!-- FORMULARIO DEL Carrera -->
    <form method="POST">
            <h1>CATALOGO DE CARRERA</h1>
            <input type="hidden" name="ID"  placeholder="Su ID">
            <br><input type="text" name="Carrera"  placeholder="Carrera"><br>
            <br><input type="text" name="Nivel"  placeholder="TSU/INGENIERIA/LICENCIATURA"><br>
        ...
        <?php
            include("guardarcarre.php"); //Llama al documento donde se registran en la base de datos
        ?>
    </body>
</html>
