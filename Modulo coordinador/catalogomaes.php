...
<html lang="en">
  <head>
    ...
    <title>Catalogo de Maestros</title>
 ...
 <!--========================================================== -->
  ...
  <nav class="navbar navbar-light px-3" style="background-color: #33afce;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light px-5">
     ...
     <form method="POST">
            <h1>CATALOGO DE PROFESOR</h1>

            <input type="hidden" name="ID"  placeholder="ID">
            <br><input type="text" name="Nombre"  placeholder="Su Nombre"><br>
            <br><input type="text" name="Carrera"  placeholder="Carrera"><br>
            <br><input type="text" name="Carrera2"  placeholder="Carrera2"><br>
           
            <br><input type="submit" name="registrar"><br>
            
        </form>
        <?php
            include("guardarmaes.php"); //Llama al documento donde se registran en la base de datos
        ?>
    </body>
</html>