...
<html lang="en">
   ...
   <meta charset="utf-8">
    ...
    <head>
        <meta charset="utf-8">
        <title>Actualizar y Editar Materias</title>
...
while($datos=mysqli_fetch_assoc($resultado)) {
  ?>
    <tr class="table-active">
        ...
        <td><?php echo $datos["cuatrimestre"];?></td>
		  
        <td><a href="RegresarMateria.php?id=<?php echo $datos["id_materia"];?>" class="btn btn-success">Editar</a></td>
        <td><a href="EliminarMateria.php?id_materia=<?php echo $datos["id_materia"];?>" class="btn btn-danger">Eliminar</a></td>
    </tr>
