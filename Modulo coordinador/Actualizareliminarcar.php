...
while($datos=mysqli_fetch_assoc($resultado)) {
  ?>
    <tr class="table-active">
        <td><?php echo $datos["id_carrera"];?></td>
        <td><?php echo $datos["carrera"];?></td>
        <td><?php echo $datos["nivel"];?></td>
		  
        <td><a href="RegresarCarrera.php?id=<?php echo $datos["id_carrera"];?>" class="btn btn-success">Editar</a></td> 
        <!-- me lleva a otras dos  -->
        <td><a href="EliminarCarrera.php?id_carrera=<?php echo $datos["id_carrera"];?>" class="btn btn-danger">Eliminar</a></td>
    </tr>
