  ...
  <nav class="navbar navbar-light px-3" style="background-color: #33afce;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light px-5">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li class="dropdown-submenu">
                            <a class="dropdown-item" href="ConsultaSecuencia.php">Secuencia Didactica</a>
                            <a class="dropdown-item" href="ConsultaCriterios.php">Criterios de la Evaluación</a>
                        </li>
                    </ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">                                            
                                <li class="dropdown-submenu">
                                    ...
                                    <a class="dropdown-item" href="pdf.php">Consulta de Evaluación</a>
                                </li>
                            </ul>   
     ...
     <form method="POST">
            ...
            <br><input type="hidden" name="id"  placeholder="ID ">
            <input type="text" name="maestro"  placeholder="Nombre del Cuatrimestre">
            <input type="text" name="materia"  placeholder="Nombre del Cuatrimestre">
            <input type="text" name="carrera"  placeholder="Nombre del Cuatrimestre">
            <input type="text" name="cuatri"  placeholder="Nombre del Cuatrimestre">
        ...
        <?php
            include("insertar.php"); //Llama al documento donde se registran en la base de datos
        ?>
    </body>
</html>