<?php
include("../db.php");
$consulta = "SELECT*FROM tbl_documentos_Criterios";
?>
<!doctype html>
<html lang="en">
   <!-- Required meta tags -->
...
while($datos=mysqli_fetch_assoc($resultado)) {
  ?>
    <tr class="table-active">
        ...
        <td><a href="../Modulo Docente/archivoCriterios.php?id=<?php echo $datos['id_documento_Criterios']?>"><?php echo $datos['nombre_archivo']; ?></a></td>
  ...
  ?>
    ...
    <form action="SubirCriterios.php">
