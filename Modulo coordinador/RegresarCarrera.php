 ...
 <!-- FORMULARIO DE  LA CARRERA -->
        <form action="ActualizarCarrera.php" method="Post"> 
            ...
            while($datos=mysqli_fetch_assoc($resultado)) {
              ?>
            <input type="hidden" name="id"  placeholder="Su ID" value="<?php echo $datos["id_carrera"];?>">  
            <input type="hidden" name="id_carrera"  placeholder="Su ID" value="<?php echo $datos["id_carrera"];?>">
            <br><input type="text" name="carrera" max="80" placeholder="Nombre de la Carrera" value="<?php echo $datos["carrera"];?>"><br>
            <br><input type="text" name="nivel" max="20" placeholder="Su nivel/tsu,inge,licen" value="<?php echo $datos["nivel"];?>"><br>
