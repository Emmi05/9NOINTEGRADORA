...
<body> 
 ...
 <!-- FORMULARIO DE  LA CARRERA -->
        <form action="ActualizarMa.php" method="Post">
            ...
            <input type="hidden" name="id_materia"  placeholder="Su ID" value="<?php echo $datos["id_materia"];?>"><br>
            <br><input type="text" name="materia" max="80" placeholder="Materia" value="<?php echo $datos["materia"];?>"><br>
            <br><input type="text" name="cuatrimestre" max="20" placeholder="Cuatrimestre" value="<?php echo $datos["cuatrimestre"];?>"><br>
