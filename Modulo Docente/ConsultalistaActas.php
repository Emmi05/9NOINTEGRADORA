<?php
include("../db.php");
$consulta = "SELECT*FROM tbl_documentos_Actas";
?>
<!doctype html>
<html lang="en">
   <!-- Required meta tags -->
...
while($datos=mysqli_fetch_assoc($resultado)) {
  ?>
    <tr class="table-active">
        ...
        <td><a href="archivoActas.php?id=<?php echo $datos['id_documento_Actas']?>"><?php echo $datos['nombre_archivo']; ?></a></td>
