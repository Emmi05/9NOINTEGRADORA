...
if (isset($_POST['subir'])) {
    ...
    $destino = "archivoActas/" . $nombre;
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            $titulo= $_POST['titulo'];
            $descri= $_POST['descripcion'];
            $db=new Conect_MySql();
            $sql = "INSERT INTO tbl_documentos_Actas(titulo,descripcion,tamanio,tipo,nombre_archivo) VALUES('$titulo','$descri','$tamanio','$tipo','$nombre')";
...
<!--FORMULARIO-->
  ...
  <div class="form-group">
    ...
    <br>
    <br>
    <button type="button" class="btn btn-info" ><a href="ConsultalistaActas.php">Consultar</a></button>
